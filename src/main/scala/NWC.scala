...
object NetworkWordCount {
  ...
  def main(args: Array[String]) {
    ...
    val postSchema: StructType = new StructType()
      .add("commentCount", IntegerType, false)
      .add("lastActivityDate", TimestampType, true)
      .add("ownerUserId", LongType, true)
      ...
      .add("acceptedAnswerId", LongType, true)
      .add("postTypeId", LongType, true)
    ...
    itPostsSplit.printSchema()

    itPostsSplit
      .filter('commentCount.isNull)
      .show(10)
